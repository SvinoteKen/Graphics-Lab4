...
namespace CG_Lab_4
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int dx = 20;
            if (comboBox2.SelectedIndex == -1) { p2.DashStyle = System.Drawing.Drawing2D.DashStyle.Dash; }
            if (comboBox2.SelectedIndex == 0) { p2.Width = 3; }
            if (comboBox2.SelectedIndex == 1) { p2.CompoundArray = new float[] { 0.0f, 0.2f, 0.3f, 0.6f, 0.7f, 1.0f }; }
            if (comboBox2.SelectedIndex == 2) { p2.DashStyle = System.Drawing.Drawing2D.DashStyle.Dot; }
